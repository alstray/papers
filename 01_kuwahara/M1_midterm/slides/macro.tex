...
%  \tabcolsep = 2mm
  ...
  \begin{tabular}[t]{c||r|r|r|r|r|r|r|r}\hline
    \lw{問題名} & \lw{既存ASP} & \multicolumn{7}{c}{提案手法}\\\cline{3-9}
...
\newenvironment{tableB}{%
 ...
 % \tabcolsep = 2mm
  ...
  \begin{tabular}[t]{c||r|r|r|r|r}\hline
    \lw{問題名} & \lw{既知の最良値} & \multicolumn{2}{c|}{既存ASP} & \multicolumn{2}{c}{提案ベスト}\\\cline{3-6}
     & & 値 & 最良値との比 & 値 & 最良値との比\\\hline
    }{%
    \hline
  \end{tabular}
}
