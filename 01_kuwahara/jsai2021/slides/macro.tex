...
\newenvironment{tableD}{%
 ...
 % \tabcolsep = 2mm
  ...
  \begin{tabular}[t]{|r|r|}\hline
    \multicolumn{1}{|c|}{\small 既存手法 ASP\footnotemark[1]} & \multicolumn{1}{c|}{\small 提案手法 LNPS}\\%\cline{2-3}
    \scriptsize{既知の最良値との比の平均 (\%)} & \scriptsize{既知の最良値との比の平均 (\%)}\\\hline
    }{%
    \hline
  \end{tabular}
}
...
\newenvironment{tableE}{%
 ...
 % \tabcolsep = 2mm
  ...
  \begin{tabular}[t]{|c|r|r|}\hline
    \lw{問題集} & \multicolumn{1}{c|}{\small 既存手法 ASP\footnotemark[1]} & \multicolumn{1}{c|}{\small 提案手法 LNPS}\\%\cline{2-3}
    & \scriptsize{既知の最良値との比の平均 (\%)} & \scriptsize{既知の最良値との比の平均 (\%)}\\\hline
    }{%
    \hline
  \end{tabular}
