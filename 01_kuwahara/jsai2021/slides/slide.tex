...
\begin{block}{}
  \centering{\small CB-CTT に関する既存研究~[Kieferほか'16]を参考に実装}
    \begin{enumerate}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{追加実験1 (他のベンチマーク問題)}
他のベンチマークに対しての有効性を評価するために，実験を行った．
\begin{block}{}
\begin{itemize}
  \item \structure{CB-CTTベンチマーク問題}
    \begin{itemize}
    \item \alert{競技会で使用されていない問題(全40問)}
   \item ソフト制約が最も多い問題集 (UD5) を使用
   \end{itemize}
  \end{itemize}
  \end{block}
  ...
  \begin{itemize}
      ...
      \item 新たに1問について，\alert{\bf 既知の最良値を更新}することに成功
  \end{itemize}
  \footnotetext[1]{得られた値は先行研究~[Banbara+ '19]から引用}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{追加実験2 (制約の少ない問題集)}
制約の少ない問題集に対しての有効性を評価するために，実験を行った．
\begin{block}{}
\begin{itemize}
  \item \structure{CB-CTTベンチマーク問題}
    \begin{itemize}
    \item 国際時間割競技会ITC-2007の問題(全21問)
    \item \alert{ソフト制約の少ない問題集 (UD1〜4) を使用}
   \end{itemize}
  \end{itemize}
  \end{block}
  \begin{center}
  ...
  \end{center}
  \begin{itemize}
      \item 提案手法は，全ての問題集において既知の最良値との比を改善
  \end{itemize}
  \footnotetext[1]{得られた値は先行研究~[Banbara+ '19]から引用}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{まとめと今後の課題}
  \begin{itemize}
    \item \structure{優先度付き巨大近傍探索 (LNPS) の提案}
     \begin{itemize}
      \item メタ戦略の一種である LNS をベースに ASP に
      適した探索手法を提案
     \end{itemize}
    \item \structure{LNPS の ASP ソルバー \textit{clingo} 上での実装}
      \begin{itemize}
      \item LNPS アルゴリズムを，
