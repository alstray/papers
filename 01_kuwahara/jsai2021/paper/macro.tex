...
%  \renewcommand{\arraystretch}{0.8}
  \begin{tabular}{c|r|rrrrrrr}
    \lw{問題名} & 既存 & \multicolumn{7}{c}{提案手法LNPS}\\\cline{3-9}
     & ASP & \textsf{R-0} & \textsf{R-3} & \textsf{R-5} & \textsf{DP} & \textsf{DR} & \textsf{SR-5} & \textsf{SR-10}\\\hline
    }{%
    \hline
  \end{tabular}
}
...
%  \renewcommand{\arraystretch}{0.8}						
  \begin{tabular}[t]{c|r|rr|rr}
    \lw{問題名} & \lw{既知の最良値($\sharp$)} & \multicolumn{2}{c|}{既存ASP} & \multicolumn{2}{c}{提案ベスト}\\\cline{3-6}
