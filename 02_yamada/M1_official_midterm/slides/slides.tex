...
\begin{frame}
  ...
  \begin{exampleblock}{その後の研究内容}
    \begin{enumerate}
      \item 組合せ遷移問題の解法として\alert{\bf 有界組合せ遷移}を提案．
 %     \item インクリメンタル ASP 解法を利用し，基本ソルバーの
 %       問題点を改良した改良ソルバーを考案・評価．
      \item ASPに基づく組合せ遷移ソルバー recongo を実装．
...
\begin{frame}\frametitle{実験結果: カクタスプロット}
  ...
  \begin{itemize}
    \item recongo は基本ソルバーより多くの問題を高速に解いている．
...
\begin{frame}\frametitle{まとめ}
  ...
  \begin{exampleblock}{今後の課題}
    ...
    \item \structure{独立集合遷移問題}への適用
      \begin{itemize}
      \item 代表的な組合せ遷移問題の一つ
      \item 組合せ遷移競技会 CoRe Challenge 2022 のベンチマーク問題
      \end{itemize}
