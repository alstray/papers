...
\subsection{0-1変数モデルのSMT符号化}\label{sec:pb}
...
\subsection{at-least-one 制約を用いたヒント制約}
...
\subsection{$distinct$制約のPB符号化を用いた改良}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{チャネリング制約を用いたクイーングラフ彩色問題のSMT符号化}\label{sec:pb_c}
