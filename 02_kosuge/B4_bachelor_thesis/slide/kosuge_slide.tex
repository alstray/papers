...
例として\verb|(distinct x_1 x_2 x_3 x_4)|は以下のように宣言される．\\
(\verb|x_i|$\in \{0,1,2,3,4\}$とする)
\begin{exampleblock}{}\scriptsize
\begin{verbatim}
(assert (distinct x_1 x_2 x_3 x_4))
(assert (or (>= x_1 3) (>= x_2 3) (>= x_3 3) (>= x_4 3)))
(assert (or (<= x_1 1) (<= x_2 1) (<= x_3 1) (<= x_4 1)))
\end{verbatim}
\end{exampleblock}
\end{frame}
...
% \frametitle{鳩の巣原理のSMT符号化}
% 鳩の巣原理を用いた高速化手法についてのSMT符号化を示す．\\
% 例として\verb|(distinct c_0_3 c_1_2 c_2_1 c_3_0)|は以下のように宣言される．\\
% (\verb|c_i_j, i, j|$\in \{0,1,2,3,4\}$である)
% \begin{exampleblock}{}\scriptsize
% \begin{verbatim}
...
%     \frametitle{at-least-one制約のSMT符号化}
% at-least-one制約を用いた高速化手法についてのSMT符号化を示す．\\
% 例として，\verb|(distinct c_0_0 c_0_1 c_0_2 c_0_3 c_0_4)|は以下のように宣言される．\\
% (\verb|c_i_j, i, j|$\in \{0,1,2,3,4\}$である)
% \begin{exampleblock}{}\scriptsize
% \begin{verbatim}
...
例として，\verb|(distinct x_0 x_1)|は以下のように宣言される．\\
(\verb|x_i|$\in \{0,1,2,3,4\}$とする)
\begin{exampleblock}{}\scriptsize
\begin{verbatim}
(assert (= (+ x_0_0 x_0_1 x_0_2 x_0_3 x_0_4) 1))
(assert (= (+ x_1_0 x_1_1 x_1_2 x_1_3 x_1_4) 1))
(assert (<= (+ x_0_0 x_1_0) 1))
(assert (<= (+ x_0_1 x_1_1) 1))
(assert (<= (+ x_0_2 x_1_2) 1))
(assert (<= (+ x_0_3 x_1_3) 1))
(assert (<= (+ x_0_4 x_1_4) 1))
\end{verbatim}
\end{exampleblock}
\end{frame}
...
例として，\verb|(distinct x_0 x_1)|は以下のような制約が追加される．\\
(\verb|x_i|$\in \{0,1,2,3,4\}$とする)
...
(assert (= y_0 (+ x_0_0 x_1_0)))
(assert (= y_1 (+ x_0_1 x_1_1)))
(assert (= y_2 (+ x_0_2 x_1_2)))
(assert (= y_3 (+ x_0_3 x_1_3)))
(assert (= y_4 (+ x_0_4 x_1_4)))
...
(assert (= (+ x_0_0 x_1_0 y_0) 1))
(assert (= (+ x_0_1 x_1_1 y_1) 1))
(assert (= (+ x_0_2 x_1_2 y_2) 1))
(assert (= (+ x_0_3 x_1_3 y_3) 1))
(assert (= (+ x_0_4 x_1_4 y_4) 1))
\end{verbatim}
\end{exampleblock}
\end{frame}
...
%     \frametitle{改良手法1のSMT符号化}
% \distinct 制約のPB符号化手法の改良手法1についてのSMT符号化を示す．\\
% 例として，\verb|(distinct c_0_1 c_1_0)|は以下のように宣言される．\\
% (\verb|c_i_j, i, j|$\in \{0,1,2,3,4\}$である)
%
% \begin{exampleblock}{}\scriptsize
% \begin{verbatim}
