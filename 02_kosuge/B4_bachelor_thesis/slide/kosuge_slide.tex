...
\begin{frame}\footnotesize
    ...
    \begin{exampleblock}{改良手法1}
        $n-1 < u-l$の時，各値$j$ごとの$x_{ij}$の和を表す変数$y_{j}$を導入し(\ref{eq:pb_1})(\ref{eq:pb_2})に以下の制約を追加する．
    \vspace{-3mm}
        \begin{eqnarray}
    ...
    \begin{exampleblock}{改良手法2}
        $n-1 < u-l$の時，各値$j$ごとに新たな変数$x_{(n+1)j}$を導入し(\ref{eq:pb_1})(\ref{eq:pb_2})に以下の制約を追加する．
    \vspace{-3mm}
        \begin{eqnarray}
