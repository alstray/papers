\chapter{配電網問題のASP符号化}\label{chap:encode}
...
basicstyle=\ttfamily\footnotesize]{code/test.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{補助アトムの導入}\label{chap:prepro}
...
breaklines=true,%
columns=fullflexible,keepspaces=true,%
basicstyle=\ttfamily\footnotesize]{code/prepro.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
breaklines=true,%
columns=fullflexible,keepspaces=true,%
basicstyle=\ttfamily\footnotesize]{code/srf1.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\lstinputlisting[float=tb,caption={%
  トポロジ制約の改良符号化},%
...
breaklines=true,%
columns=fullflexible,keepspaces=true,%
basicstyle=\ttfamily\footnotesize]{code/srf2.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\lstinputlisting[float=tb,caption={%
  トポロジ制約の有向符号化},%
...
breaklines=true,%
columns=fullflexible,keepspaces=true,%
basicstyle=\ttfamily\footnotesize]{code/srf3.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
breaklines=true,%
columns=fullflexible,keepspaces=true,%
basicstyle=\ttfamily\footnotesize]{code/electrical.lp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
7行目のルールは，各ジャンクション\code{X}に属するセクション\code{S}に
