\begin{tikzpicture}
 ...
 \draw[very thick, draw=blue, densely dashed] (A) circle[x radius=0.8,y radius=2.2];
 \draw[very thick, draw=blue, densely dashed] (B) circle[x radius=0.8,y radius=1.8];
 \draw[very thick, draw=blue, densely dashed] (C) circle[x radius=0.8,y radius=1.8];
