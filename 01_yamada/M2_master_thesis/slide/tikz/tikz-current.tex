...
\begin{tikzpicture}[scale=0.5]
 ...
 \node[node, thick, fill=node1, draw=edge1, right=2cm of 1] (2){30A};
 \node[node, thick, fill=node1, draw=edge1, right=2cm of 2] (3){20A};
 \node[node, thick, fill=node1, draw=edge1, right=2cm of 3] (4){10A};
 ...
 \draw [line width=3.5pt, edge1] (1) -- node[above, font=\Large] {\textbf{60A}}(5,0) -- (2);
 \draw [line width=2.5pt, edge1] (2) -- node[above, font=\Large] {\textbf{30A}}(11,0) -- (3);
 \draw [line width=1.5pt, edge1] (3) -- node[above, font=\large] {\textbf{10A}}(17,0) -- (4);
