...
\begin{tikzpicture}[scale=0.6]
 ...
 % 設定
 \tikzset{customer/.style={rectangle,thick,draw=black,minimum height=0.6cm,minimum width=0.6cm,fill=white}}
 ...
 \node[customer] at (0,0) (2){2};
 \node[customer, draw=edge3, very thick, fill=node3] at (3,0) (3){};
 \node[customer] at (-3,-3) (4){4};
 \node[customer] at (0,-3) (5){5};
 \node[customer] at (3,-3) (6){6};
