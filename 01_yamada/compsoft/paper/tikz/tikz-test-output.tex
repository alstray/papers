...
\begin{tikzpicture}
 ...
 \swnodeB{above =of node6,fill=black!10}{node7}{sw7}{ };
 \swnodeA{above =of node7,fill=black!10}{node29}{sw29}{ };
 ...
 % root2
 \node[customer,fill=black!10,above=4.5cm of sub, fill=black!10] (root2) { };
 ...
 % root3
 \node[customer,fill=black!10,right=5.2cm of sub,pattern=north east lines] (root3) { };
