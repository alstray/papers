\begin{tikzpicture}
 ...
 \draw[very thick, draw=red, densely dashed] (A) circle[x radius=0.8,y radius=2.2];
 \draw[very thick, draw=red, densely dashed] (B) circle[x radius=0.8,y radius=1.8];
 \draw[very thick, draw=red, densely dashed] (C) circle[x radius=0.8,y radius=1.8];
