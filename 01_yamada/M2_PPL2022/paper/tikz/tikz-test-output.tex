...
\begin{tikzpicture}
 ...
 \swnodeB{above =of node6,pattern=dots}{node7}{sw7}{ };
 \swnodeA{above =of node7,pattern=dots}{node29}{sw29}{ };

 \swnodeB{above =of node29,pattern=dots}{node30}{sw30}{ };
 
 \swnodeB{above =of node4,fill=black!40}{node8}{sw8}{ };
 \swnodeA{above =of node8,fill=black!40}{node31}{sw31}{ };
 
 \swnodeB{above =of node31,pattern=dots}{node32}{sw32}{ };
 ...
 % root2
 \node[customer,fill=black!20,above=4.5cm of sub, pattern=dots] (root2) { };
 \swnodeL{left =of root2,pattern=dots}{node9}{sw9}{ };

 \swnodeR{left=of node9,pattern=dots}{node10}{sw10}{ };
 \node[customer,left=of node10,pattern=dots] (junc2){ };
 \swnodeL{left =of junc2,pattern=dots}{node11}{sw11}{ };
 \swnodeB{below =of junc2,pattern=dots}{node12}{sw12}{ };
 
 \swnodeR{left =of node11,pattern=dots}{node13}{sw13}{ };
 \swnodeB{below =of node13,pattern=dots}{node14}{sw14}{ };
 
 \swnodeA{below =of node14,pattern=dots}{node15}{sw15}{ };

 \swnodeA{below =of node12,pattern=dots}{node16}{sw16}{ };

 \swnodeR{right =of root2,pattern=dots}{node22}{sw22}{ };

 \swnodeL{right =of node22,pattern=dots}{node23}{sw23}{ };
 ...
 \swnodeB{above =of node25,pattern=north east lines}{node26}{sw26}{ };
 \swnodeL{above =1.3of node26,pattern=north east lines}{node27}{sw27}{ };

 \swnodeR{left =of node27,pattern=dots}{node28}{sw28}{ };
