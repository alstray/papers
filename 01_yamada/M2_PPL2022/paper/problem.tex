...
\begin{figure}[tbp]
 \centering
 \input{tikz/tikz-test-netsuki-input}
 \caption{根付き全域森問題の入力}
...
\begin{figure}[tbp]
 \centering
 \input{tikz/tikz-test-netsuki-output}
 \caption{根付き全域森問題の出力}
...
この組合せ遷移問題を\textbf{配電網遷移問題}と呼ぶ．本研究では，遷移制約を各ステップ$t$で
切替可能なスイッチの個数を2個に制限する．
