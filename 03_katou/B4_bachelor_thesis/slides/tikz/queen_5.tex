\begin{tikzpicture}
 ...
 \draw[red] (1,1.25)--(1,-1.25);
 \draw[red] (-1.25,0.5)--(1.25,0.5);
 \draw[red] (0.25,1.25)--(1.25,0.25);
 \draw[red] (-0.76,-1.25)--(1.25,0.76);
 \fill[magenta] (-1,1) circle (0.03);
 \fill[red] (1,0.5) circle (0.03);
...
align=center,minimum height=0.43cm}]{
 ...
 \quad & \quad & \quad & \quad & \textcolor{red}{\symqueen} \\
