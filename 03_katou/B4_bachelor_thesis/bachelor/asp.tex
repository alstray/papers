...
が成り立つ」を意味する．
さらに，個数制約に(\code{#sum})を組み込むと，重み付きの個数制約を表すことができる．例えば，\( \leftarrow lb\ \#sum\ \{a_1:w_1;\dots;a_n:w_n\}\ ub \)と書くと，「$a_1,\dots,a_n$のうち，成り立つものの重み$w_1,\dots,w_n$の和が$lb$以上$ub$以下であることはない」を意味する．
