...
\section{支配集合問題}
グラフ$G=(V,E)$の頂点の部分集合$S\subset V$において，任意の頂点$u \in V-S$に対して$(u,v) \in E$である$v \in S$が存在するとき，$S$を$G$の\textbf{支配集合}という．
...
支配集合問題で，グラフの頂点を「町」，辺を「二つの町の間で電波の届く関係」とみなすと，支配数の決定は電波塔の最適な配置に対応づけられる．また，支配数や支配集合はスケジューリングなど多くの問題に応用されている
