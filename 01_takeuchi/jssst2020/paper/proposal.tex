...
\code{v_def/3},
\code{require_v_v/2},
\code{exclude_v_v/2}\comment{exclude\_v\_v $\rightarrow$ exclude\_v\_v/2}
に対応していることがわかる．
...
%  \small
  ...
  \begin{tabular}{l|l|c|c|c||c|c|c||c|c|c} \bhline
    ...
    \multicolumn{2}{l|}{IWR}  & 1128 & 1130   & 1255    & 1130 & 1130&1255  & 1130& 1130& 1255     \\ %\hline
...
予想販売台数の最大化(2行目)\comment{2行目の $\rightarrow$ 2行目}については，これまでと同じである．
